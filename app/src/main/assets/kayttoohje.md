...
- **Konfigurointi:**
    ...
    - **Laskentatapa:** Voit vaihtaa ruudun käyntikertojen laskentatapaa. Vaihtoehto **Reittipisteet + 3x sessiot** laskee jokaisesta ruudun reittipisteestä yhden pisteen ja jokaisesta ruudussa käyneestä sessiosta kolme pistettä. Säätämällä pistemäärän minimi- ja maksimiarvoja ruutua kohden voit määrittää, minkä pistemäärän tietty heat mapin värisävy vaatii.<br><br>
